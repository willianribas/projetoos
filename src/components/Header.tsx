...
const Header = () => {
  ...
  return (
    <motion.div 
      ...
      className="glass-panel rounded-xl shadow-lg border-white/5 transition-all duration-300 hover:shadow-xl p-4"
    >
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex flex-col items-center sm:items-start gap-2 w-full sm:w-auto">
          <img 
            ...
            alt="Daily.Flow Logo" 
            className="h-[40px] sm:h-[45px] w-auto object-contain drop-shadow-md"
          />
